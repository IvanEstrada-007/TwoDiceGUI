"""
1/13/2023  Program: TwoDiceGUI.py

Chapter 8 example demostrating a GUI-based model of rolling dice vs a randomized computer roll. A possibility for a tie is also built in with different text headings below the ROLL DICE button depending on the outcome.
